...
# Generation date: 2023-02-15T16:51:32
# Schema: ARS-Schema
#
...
class OrderedListItem(NamedObject):
    ...
    analysis: Optional[Union[str, AnalysisId]] = None
    output: Optional[Union[str, OutputId]] = None
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if self.analysis is not None and not isinstance(self.analysis, AnalysisId):
            self.analysis = AnalysisId(self.analysis)

        if self.output is not None and not isinstance(self.output, OutputId):
            self.output = OutputId(self.output)
...
class Analysis(YAMLRoot):
    ...
    analysisSet: Optional[Union[str, AnalysisSetId]] = None
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if self.analysisSet is not None and not isinstance(self.analysisSet, AnalysisSetId):
            self.analysisSet = AnalysisSetId(self.analysisSet)
...
slots.analysis = Slot(uri=DEFAULT_.analysis, name="analysis", curie=DEFAULT_.curie('analysis'),
                   model_uri=DEFAULT_.analysis, domain=None, range=Optional[Union[str, AnalysisId]])

slots.analysisSet = Slot(uri=DEFAULT_.analysisSet, name="analysisSet", curie=DEFAULT_.curie('analysisSet'),
                   model_uri=DEFAULT_.analysisSet, domain=None, range=Optional[Union[str, AnalysisSetId]])
...
slots.output = Slot(uri=DEFAULT_.output, name="output", curie=DEFAULT_.curie('output'),
                   model_uri=DEFAULT_.output, domain=None, range=Optional[Union[str, OutputId]])
